...
/* Guest checkout: post to the cloud, preserve the selected store/branch, show
   the server's human-readable error verbatim, and never surface raw browser
   exceptions (e.g. WebKit's "The string did not match the expected pattern.")
   in the toast. */
const checkout =
...
patchFile(swPath, (sw) => sw.replace(/kashikeyo-2\.[0-9]\.\d+/g, "kashikeyo-2.9.3"));
