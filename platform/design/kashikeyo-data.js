...
(function () {
  ...
  // Guest-facing promo banners, authored in the POS merchant portal
  // (Promotions & Banners) and published to the QR ordering app. outlet 0 =
  // every outlet in the chain; a code is optional — a banner may simply
  // announce something. Nothing here prices anything: a code still has to
  // exist at the till, which is where a discount is actually granted.
  var BANNERS = [
    { id: "b1", outlet: 0, title: "Reef ceviche, two for one", sub: "Every day 17:00–19:00 · dine-in only", code: "REEF5", img: IMG("photo_1615141982883_c7ad0e69fd62"), active: true },
    { id: "b2", outlet: 0, title: "Grill night, every Thursday", sub: "Whole reef fish and the 450g striploin, fired over coconut husk", code: "", img: IMG("photo_1558030006_450675393462"), active: true },
    { id: "b3", outlet: 3, title: "5% off your first QR order", sub: "Enter KASHI5 before you send the round", code: "KASHI5", img: IMG("photo_1604909052743_94e838986d24"), active: true }
  ];

  // Sell-side modifiers. Real chain data: the till, the KOT and the QR menu all
  // read this one list, so a guest can never pick an add-on the kitchen has no
  // ticket line for. cats = menu categories the modifier is offered on.
  var MODIFIERS = [
    { id: "mo1", name: "Double portion", price: 45, cats: ["mains"] },
    { id: "mo2", name: "Extra sambol", price: 15, cats: ["mains", "starters", "sides"] },
    { id: "mo3", name: "Garlic butter", price: 25, cats: ["mains"] },
    { id: "mo4", name: "Extra dip", price: 15, cats: ["starters", "sides"] },
    { id: "mo5", name: "Make it large", price: 35, cats: ["starters", "sides"] },
    { id: "mo6", name: "Chilli crunch", price: 10, cats: ["starters", "sides", "mains"] },
    { id: "mo7", name: "Double shot", price: 20, cats: ["drinks"] },
    { id: "mo8", name: "No ice", price: 0, cats: ["drinks"] },
    { id: "mo9", name: "Coconut water swap", price: 15, cats: ["drinks"] },
    { id: "mo10", name: "Extra scoop", price: 25, cats: ["desserts"] },
    { id: "mo11", name: "Hot chocolate sauce", price: 15, cats: ["desserts"] }
  ];

  // Loyalty tiers and the reward catalogue are merchant data, not app constants:
  // the till reads the same rows when it settles a bill.
  var TIERS = [
  ...
  // kind: "item" redeems a specific menu item, "money" is an amount off.
  var REWARDS = [
    { id: "rw1", kind: "item", cat: "drinks", name: "Free drink", sub: "Any one from the drinks list", cost: 300 },
    { id: "rw2", kind: "item", cat: "starters", name: "Free starter", sub: "One starter, dine-in", cost: 500 },
    { id: "rw3", kind: "item", cat: "desserts", name: "Free dessert", sub: "One dessert with any main", cost: 650 },
    { id: "rw4", kind: "money", off: 150, min: 500, name: "MVR 150 off", sub: "Off a bill of MVR 500 or more", cost: 1200 },
    { id: "rw5", kind: "item", cat: "mains", name: "Chef's table for two", sub: "Booked by the outlet", cost: 4000, tier: "platinum" }
  ];
  ...
  var CUSTOMERS = [
    { id: "c1", name: "Aishath Rifga", phone: "+960 777 4821", email: "rifga@mailbox.mv", since: "2023-02-11", visits: 24, spent: 18420, points: 1842, tier: "Platinum", credit: 2500, used: 940, last: "Today" },
    { id: "c2", name: "Mohamed Zayan", phone: "+960 991 2077", email: "zayan.m@mailbox.mv", since: "2024-06-03", visits: 11, spent: 7310, points: 731, tier: "Gold", credit: 1500, used: 1500, last: "2 days ago" },
    { id: "c3", name: "Sarah Lindqvist", phone: "+46 70 118 9920", email: "s.lindqvist@post.se", since: "2025-11-19", visits: 4, spent: 4180, points: 418, tier: "Silver", credit: 0, used: 0, last: "Yesterday" },
    { id: "c4", name: "Ibrahim Faisal", phone: "+960 778 0164", email: "ifaisal@atollgroup.mv", since: "2022-09-30", visits: 31, spent: 22960, points: 2296, tier: "Platinum", credit: 5000, used: 1120, last: "Today" },
    { id: "c5", name: "Hawwa Nazly", phone: "+960 966 3345", email: "hawwa.nazly@mailbox.mv", since: "2025-04-27", visits: 7, spent: 3120, points: 312, tier: "Silver", credit: 1000, used: 0, last: "1 week ago" },
    { id: "c6", name: "Daniel Okafor", phone: "+44 7700 900412", email: "d.okafor@post.co.uk", since: "2026-05-02", visits: 2, spent: 1560, points: 156, tier: "Bronze", credit: 0, used: 0, last: "3 weeks ago" }
  ];
  ...
  var ACCOUNTS = [
    ...
    // Contra-revenue. Discounts are shown, never netted into 4000: a chain that
    // nets them cannot tell a good month from a heavily discounted one.
    { code: "4200", name: "Discounts & allowances", type: "Revenue" },
    { code: "4900", name: "Cash rounding", type: "Revenue" },
  ...
  var OPEX = [
    ...
    { id: "e18", cat: "Bank & card fees", vendor: "Bank of Maldives", outlet: 0, amt: 11800, freq: "monthly", due: 30, acct: "5600" },

    // ── Selling ────────────────────────────────────────────────────────────
    { id: "e19", cat: "Marketing & social", vendor: "Meta Ads", outlet: 0, amt: 8500, freq: "monthly", due: 1, acct: "6500" },
    { id: "e20", cat: "Photography & content", vendor: "Studio Fann", outlet: 0, amt: 4200, freq: "monthly", due: 10, acct: "6500" },
    { id: "e21", cat: "Printed menus & signage", vendor: "Novelty Printers", outlet: 0, amt: 2600, freq: "annual", due: 14, acct: "6500" },
    { id: "e22", cat: "Music licence", vendor: "Maldives Music Rights", outlet: 0, amt: 3400, freq: "annual", due: 20, acct: "6500" },

    // ── Travel and movement ────────────────────────────────────────────────
    { id: "e23", cat: "Staff ferry & transport", vendor: "MTCC Ferry", outlet: 0, amt: 9800, freq: "monthly", due: 5, acct: "6600" },
    { id: "e24", cat: "Inter-island travel", vendor: "Maldivian", outlet: 0, amt: 14500, freq: "monthly", due: 12, acct: "6600" },
    { id: "e25", cat: "Vehicle fuel & upkeep", vendor: "Villa Fuel", outlet: 3, amt: 5600, freq: "monthly", due: 18, acct: "6600" },

    // ── Professional and compliance ────────────────────────────────────────
    { id: "e26", cat: "Audit & accountancy", vendor: "KPMG Maldives", outlet: 0, amt: 48000, freq: "annual", due: 15, acct: "6700" },
    { id: "e27", cat: "Legal & company secretarial", vendor: "Shah Hussain & Co", outlet: 0, amt: 18000, freq: "annual", due: 15, acct: "6700" },
    { id: "e28", cat: "Recruitment & agency", vendor: "Island Manpower", outlet: 0, amt: 12000, freq: "annual", due: 22, acct: "6700" },
    { id: "e29", cat: "Training & certification", vendor: "Maldives Food Safety", outlet: 0, amt: 6400, freq: "annual", due: 26, acct: "6700" },

    // ── Keeping the room open ──────────────────────────────────────────────
    { id: "e30", cat: "Cleaning & chemicals", vendor: "Ensis Hygiene", outlet: 3, amt: 6200, freq: "monthly", due: 8, acct: "6800" },
    { id: "e31", cat: "Laundry & uniforms", vendor: "Hulhumale Laundry", outlet: 0, amt: 7400, freq: "monthly", due: 10, acct: "6800" },
    { id: "e32", cat: "Pest control", vendor: "Rentokil Maldives", outlet: 0, amt: 3800, freq: "monthly", due: 16, acct: "6800" },
    { id: "e33", cat: "Security", vendor: "Guardian Security", outlet: 4, amt: 9200, freq: "monthly", due: 2, acct: "6800" },
    { id: "e34", cat: "Smallwares & breakage", vendor: "Hotelier Supplies", outlet: 0, amt: 4800, freq: "monthly", due: 24, acct: "6800" }
  ];
  ...
  ACCOUNTS.push(
    ...
    // Not 5300: that is wages. A merchant fee booked to payroll overstates labour
    // and understates the cost of taking cards, which is a real decision input.
    ...
    // Variable, not fixed: these scale with covers and with delivery orders, so
    // they belong beside cost of sales where a margin calculation will see them.
    { code: "5700", name: "Packaging & consumables", type: "Expense" },
    { code: "5800", name: "Delivery commission", type: "Expense" }
  );

  // ── Allergens ─────────────────────────────────────────────────────────────
  // Derived from the recipe, never tagged per dish. A dish is allergenic because
  // of what is IN it, so tagging the dish duplicates a fact the item master
  // already holds — and duplicated facts drift: change the recipe and the tag
  // silently lies. Tag the ingredient once, every dish inherits it, and a recipe
  // change updates the menu, the guest's filter and the kitchen note together.
  //
  // Matching is on the item's own name and category, which is the level a chef
  // actually reasons at. A manager can still force an allergen onto a dish
  // (cross-contamination in a shared fryer is real and no ingredient list shows
  // it) — that override lives on the dish, additive only, never subtractive.
  var ALLERGENS = [
  ...
  // Diets are the absence of things, so they are derived the same way rather than
  // being a second flag someone has to remember to keep in step with the recipe.
  var DIETS = [
  ...
  window.KPOS = {
    ...
    CHAIN: CHAIN, OUTLETS: OUTLETS, MENU: MENU, MENU_CATEGORIES: MENU_CATEGORIES, BANNERS: BANNERS,
    MODIFIERS: MODIFIERS, TIERS: TIERS, REWARDS: REWARDS,
