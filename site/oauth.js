...
(function () {
  function storeSessionAndGo(data) {
    ...
    /* Brand-new social sign-ins finish setup on /welcome (store name,
       currency, PIN — chosen there, so no PIN alert needed yet). */
    if (data.needsSetup) { location.href = "/welcome"; return; }
